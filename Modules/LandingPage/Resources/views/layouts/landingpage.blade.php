...
<head>
    <title>
        {{ \App\Models\Utility::GetValueByName('title_text', APP_THEME()) ? \App\Models\Utility::GetValueByName('title_text', APP_THEME()) : ( env('APP_NAME') ?? 'Ecommercego saas') }}
    </title>
    <!-- Meta -->
    <meta charset="utf-8" />
                ...
                <div class="col-xxl-4 col-md-6">
                    ...
                    <div class="d-flex gap-3 mt-4 banner-btn">
                        ...
                        @if ($settings['home_buy_now_link'])
                            <a href="{{ $settings['home_buy_now_link'] }}" class="btn btn-outline-dark">{{ __('Buy Now')}} <i
                ...
                <div class="col-xxl-4">
                    ...
                    @if ($settings['feature_buy_now_link'])
                        <a href="{{ $settings['feature_buy_now_link'] }}"
                            class="btn btn-primary rounded-pill d-inline-flex align-items-center">{{ __('Buy Now')}} <i
                                data-feather="lock" class="ms-2"></i></a>
                    @endif
                </div>
                <div class="col-xxl-8">
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                ...
                @if (isset($settings['discover_buy_now_link']) && $settings['discover_buy_now_link'])
                    <a href="{{ $settings['discover_buy_now_link'] }}" class="btn btn-primary rounded-pill">{{ __('Buy Now')}}
    ...
    <section class="screenshots section-gap">
        <div class="container">
            ...
            <div class="row gy-4 gx-4">
                @if (isset($settings['screenshots']) && (is_array(json_decode($settings['screenshots'], true)) || is_object(json_decode($settings['screenshots'], true))))
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <span
                                    class="mb-4 f-w-600 p-price">{{ !empty($setting['CURRENCY']) ? $setting['CURRENCY'] : '$' }}{{ $value->price }}<small
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        @if (isset($settings['faqs']) && (is_array(json_decode($settings['faqs'], true)) || is_object(json_decode($settings['faqs'], true))))
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-8">
                    <div class="row justify-content-center gy-3">
                        @if (isset($settings['testimonials']) && (is_array(json_decode($settings['testimonials'])) || is_object(json_decode($settings['testimonials']))))
                        ...
                        @foreach (json_decode($settings['menubar_page']) as $key => $value)
                            @if ($value->footer == 'on' && $value->header == 'off')
                                <li>
                                    ...
                                    @else
                                        <a href="{{ route('custom.pages', $value->page_slug) }}">{!! $value->menubar_page_name !!}</a>
                                    @endif
