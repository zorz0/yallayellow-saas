                                                    ...
                                                    <div class="px-2 py-2">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto actions">
                                                                <a data-repeater-delete href="javascript:void(0)" class="action-item btn btn-sm btn-icon btn-danger repeater-action-btn ms-2">
                                                ...
                                                <div class="card mb-3 border shadow-none product_Image">
                                                    <div class="px-2 py-2">
                                                        <div class="row align-items-center">
                                                            <div class="col ml-n2">
                                                                <p class="card-text small text-muted">
                                                                    <img class="rounded" src="{{ asset($home_logo) }}" width="70px" alt="Image placeholder" data-dz-thumbnail="">
                                                                </p>
                                                            </div>
                                                            <div class="col-auto actions">
                                                                <a class="action-item btn btn-sm btn-icon btn-info" href="{{ asset($home_logo) }}" download="" data-toggle="tooltip" data-original-title="Download">
                                                                    <i class="ti ti-download"></i>
                                                                </a>
                                                            </div>
                                                            <div class="col-auto actions">
                                                                <a class="action-item btn btn-sm btn-icon btn btn-sm btn-danger delete-button " data-image="{{ $home_logo }}">
                                                                    <i class="ti ti-trash text-white py-1"></i>
                                                                </a>
                                                            </div>
                                                        </div>
