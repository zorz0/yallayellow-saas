...
class FeaturesController extends Controller
{
    ...
    public function feature_store(Request $request){
        ...
        return redirect()->back()->with(['success'=> __('Feature add successfully')]);
    }
    ...
    public function feature_update(Request $request, $key){
        ...
        return redirect()->back()->with(['success'=> __('Feature update successfully')]);
    }
    ...
    public function feature_delete($key){
        ...
        return redirect()->back()->with(['success'=> __('Feature delete successfully')]);
    }
    ...
    public function features_delete($key){
        ...
        return redirect()->back()->with(['success'=> __('Features delete successfully')]);
    }
}
