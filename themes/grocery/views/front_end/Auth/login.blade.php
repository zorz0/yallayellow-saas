                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control" value="grocery@example.com" placeholder="company@example.com" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password"  class="form-control" value="grocery@example.com" placeholder="**********" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
