            ...
            <div class="mini-cart-item">
                ...
                <div class="mini-cart-details">
                    ...
                    <div class="pvarprice d-flex align-items-center justify-content-between">
                        <div class="price">
                            <ins>{{ currency_format_with_sym($item->final_price, $store->id, $currentTheme)  }} </ins><del>{{ currency_format_with_sym($item->total_orignal_price, $store->id, $currentTheme) ?? SetNumberFormat($item->total_orignal_price) }}</del>
                        </div>
    ...
    <div class="mini-cart-footer mini-cart-footer1">
        @if (!empty($response->data->cart_total_product))
            <div class="u-save d-flex justify-end">
                {{ __("Subtotal") }}: {{ currency_format_with_sym($response->data->final_price, $store->id, $currentTheme) ?? SetNumberFormat($response->data->final_price ?? ($response->data->sub_total ?? 0)) }}
            </div>
            <div class="u-save d-flex justify-end">
