                        ...
                        <a href="{{ url($slug.'/product/'.$item->slug) }}">
                            ...
                            <div class="product-btn-wrp">
                                ...
                                @if(isset($module) && $module->isEnabled())
                                    ...
                                    @include('productquickview::pages.button', ['product_slug' => $item->slug ?? null, 'slug' => $slug ?? null, 'currentTheme' => $currentTheme])
                                @endif
                                @if(isset($compare_module) && $compare_module->isEnabled())
                                    {{-- Include the module blade button --}}
                                    @include('productcompare::pages.button', ['product_slug' => $item->slug ?? null, 'slug' => $slug ?? null, 'currentTheme' => $currentTheme])
                                @endif
                            </div>
                        </a>
                    </div>
