<section class="shop-reviews padding-top padding-bottom" style="position: relative;@if(isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif" data-index="{{ $option->order ?? '' }}" data-id="{{ $option->order ?? '' }}" data-value="{{ $option->id ?? '' }}" data-hide="{{ $option->is_hide ?? '' }}" data-section="{{ $option->section_name ?? '' }}"  data-store="{{ $option->store_id ?? '' }}" data-theme="{{ $option->theme_id ?? '' }}">
            ...
            <div class="col-lg-5 col-md-5 col-12">
                <div class="shop-reviews-left-inner">
                    ...
                    <div class="section-title">
                        <h2 class="title" id="{{ $section->variant_background->section->title->slug ?? '' }}_preview">
                    ...
                    <a href="{{ route('page.product-list', $slug) }}" class="btn"
                        ...
                        {{ $section->variant_background->section->button->text ?? '' }} <svg
                            ...
                            <div class="review-box-wrapper">
                                <div class="">
                                    <div class="user-pro-list">
                                        <ul class="">
                                            <li>
                                                <img class="{{ ($section->variant_background->section->image->slug ?? '').'_preview'}}"
                            src="{{ asset($section->variant_background->section->image->image ?? '')}}" alt="user1">
                                            </li>
