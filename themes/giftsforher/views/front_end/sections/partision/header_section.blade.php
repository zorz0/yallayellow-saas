            ...
            <div class="navigationbar-row d-flex justify-content-between align-items-center">
                <div class="logo-col">
                    <h1>
                        ...
                        <img src="{{ isset($theme_logo) && !empty($theme_logo) ? $theme_logo : asset('themes/' . $currentTheme . '/assets/images/logo.png') }}" alt="Logo">
                        </a>
                    </h1>
                </div>
                    ...
                    <div class="menu-item-right">
                                    ...
                                    <div class="menu-dropdown">
                                        <ul>
                                            <li><a href="{{ route('my-account.index',$slug) }}"
                                                    style="width: auto; background-color: transparent;">{{__('My Account')}}</a>
                                            </li>
                                            <li>
                        ...
                        <ul class="menu-right-end">
                            <li class="cart-header">
                                <a href="javascript:;">
                                    <span class="icon-lable">{{__('My Cart:')}} <b> <span
                                                id="sub_total_main_page">{{ 0 }}</span>{{__('USD')}}</b></span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"
                                        fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <span class="count" style="left: 74px;">{!! \App\Models\Cart::CartCount($slug)
                                        !!}</span>
                                </a>
                            </li>
                ...
                <li class="mobile-item has-children">
                    ...
                    <ul class="mobile_menu_inner acnav-list">
                        <li class="menu-h-link">
                            <ul>
                                @foreach ($pages as $page)
                                <li><a href="{{ route('custom.page', [$slug,$page->page_slug]) }}">{{$page->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </li>
