    ...
    <div class="container">
                ...
                <div class="shop-protab-itm product-card">
                    <div class="product-card-inner">
                        <div class="product-card-image">
                            <a href="{{ route('page.product', [$slug, $product->slug]) }}" class="product-img">
                        ...
                        <div class="product-content">
                            <div class="product-content-top">
                                ...
                                <h3 class="product-title"><a class="title"
                                        href="{{ route('page.product', [$slug, $product->slug]) }}">{{ $product->name }}</a>
                                </h3>
                            </div>
                            <div class="product-content-bottom">
                                <div class="pro-bottom-price">
                                    ...
                                    <div class="custom-output">
                                        {!! \App\Models\Product::productSalesPage($currentTheme, $slug, $product->slug) !!}
                                    </div>
                                </div>
        ...
        <div class="d-flex justify-content-center">
            <a href="{{ route('page.product-list', $slug) }}"
                class="btn-secondary btn-secondary-theme-color"id="{{ $section->best_product_second->section->button->slug ?? '' }}_preview">
