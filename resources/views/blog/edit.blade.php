...
<div class="d-flex justify-content-end mb-1">
    <a href="#" class="btn btn-primary me-2 ai-btn" data-size="lg" data-ajax-popup-over="true" data-url="{{ route('generate',['blog']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('توليد') }}" data-title="{{ __('توليد المحتوى بواسطة الذكاء الاصطناعي') }}">
...
<div class="row">
    ...
    <div class="form-group  col-md-6">
        ...
        {!! Form::select('category_id', $blogCategoryList, null, ['class' => 'form-control select category', 'data-role' => 'tagsinput', 'id' => 'category_id', 'name' =>'category_id','placeholder' => 'اختر الخيار']) !!}
    </div>
