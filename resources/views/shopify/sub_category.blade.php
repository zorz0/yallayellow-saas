                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                {{-- @permission('Edit Shopify SubCategory') --}}
                                                    <a href="{{ route('shopify_sub_category.edit', $cat_data['id']) }}"  class="btn btn-sm btn-info"
                                                ...
                                                {{-- @permission('Create Shopify SubCategory') --}}
                                                    <a href="{{ route('shopify_sub_category.show', $cat_data['id']) }}" class="btn btn-sm btn-primary"
                                                        data-title="Add sub-category"
                                                        data-toggle="tooltip" title="{{ __('Create Sub Category') }}">
                                                        <i class="ti ti-plus" data-bs-toggle="tooltip" title="Add SubCategory"></i>
                                                    </a>
                                                    {{-- @endpermission --}}
                                                @endif
                                            </td>
