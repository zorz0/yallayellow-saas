                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 product-card">
                                        <div class="product-card-inner">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <div class="price">
                                                    <ins><span class="currency-type">{{ currency_format_with_sym(ModulePriceByName($module->getName())['monthly_price'] ?? 0) }}</span> <span class="time-lbl text-muted">{{ __('/Month') }}</span></ins>
                                                            <ins><span class="currency-type">{{ currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price'] ?? 0) }}</span> <span class="time-lbl text-muted">{{ __('/Year') }}</span></ins>
                                                </div>
