                ...
                <div class="col-md-6 col-12">
                    <div class="banner-image-wrapper">
                        ...
                        <div class="banner-img-wrapper">
                            <img src="{{ asset('public/market_assets/images/banner-image.png')}}" alt=""  class="main-banner" >
                            <img src="{{ asset('public/market_assets/images/banner-image-rtl.png')}}" alt=""  class="rtl-banner">
                            <img src="{{ asset('public/market_assets/images/images1.png')}}" alt="" class="inner-frame-img">
                       </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="partners-logo-slider">
                    @for ($i = 1; $i < 15; $i++)
                        <div class="logo-item">
                            <a href="#">
                                <img src="{{ asset('public/market_assets/images/logo-dark.png')}}" alt="exclusive partner">
                            </a>
                        </div>
                    @endfor
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 col-12">
                        <div class="dash-theme-preview">
                            <img src="{{ asset('public/market_assets/images/account_image1.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white padding-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7  col-md-6 col-12">
                        <div class="dash-theme-preview">
                            <img src="{{ asset('public/market_assets/images/hrm_image1.png')}}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
        ...
        <div class="bg-light padding-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 col-12">
                        <div class="dash-theme-preview">
                            <img src="{{ asset('public/market_assets/images/taskly_image1.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white padding-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-12">
                        <div class="dash-theme-preview">
                            <img src="{{ asset('public/market_assets/images/lead_image1.png')}}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
        ...
        <div class="bg-white padding-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 col-12">
                        <div class="dash-theme-preview">
                            <img src="{{ asset('public/images/pos_image1.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="theme-preview-section">
        <div class="container">
            <div class="theme-preview-slider">
                ...
                <div class="theme-preview-itm">
                    <div class="preview-itm">
                        <img src="{{ asset('public/market_assets/images/pos_image1.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
