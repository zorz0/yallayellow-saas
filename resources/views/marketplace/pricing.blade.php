            ...
            <div class="row row-gap align-items-center justify-content-center">
                ...
                <div class="col-lg-3 col-md-5 col-12">
                    <div class="banner-image">
                        <img src="{{ asset('public/market_assets/images/dash-banner-image.png') }}" alt="">
                                        ...
                                        <div class="product-card-inner">
                                                    ...
                                                    <div class="product-content">
                                                        ...
                                                        <div class="price d-flex justify-content-between">
                                                            <ins class="m-price-monthly"><span class="currency-type">{{ currency_format_with_sym(ModulePriceByName($module->getName())['monthly_price'] ?? 0) }}</span> <span class="time-lbl text-muted">{{ __('/Month') }}</span></ins>
                                                            <ins class="m-price-yearly d-none"><span class="currency-type">{{ currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price'] ?? 0) }}</span> <span class="time-lbl text-muted">{{ __('/Year') }}</span></ins>
                                                        </div>
