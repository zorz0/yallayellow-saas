{{Form::model($review, array('route' => array('review.update', $review->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data')) }}
<div class="row">
    ...
    <div class="form-group  col-md-6 product_id_div" data_val='{{ $review->product_id }}'>
