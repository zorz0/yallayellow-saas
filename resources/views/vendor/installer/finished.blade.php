...
@section('container')
	...
	<p style="color:red;"><strong>Admin Dashboard : {{ url('/login') }}</strong></p>
	<p style="color:red;"><strong>Default Admin Created : admin@example.com / 1234</strong></p>
	<p style="color:red;"><strong>Default SuperAdmin Created : superadmin@example.com / 1234</strong></p>

	{{-- <p style="color:red;"><strong>Frontend URL : {{ url('/') }}</strong></p>	
	<p style="color:red;"><strong>Default customer Created : customer@example.com / 1234</strong></p> --}}
