            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-12">
                    <div class="section-title text-center">
                        ...
                        @endif
                        <p><b>{{ __('Your order has been successfully processed!') }}</b><br>
                            {{ __('Please direct any questions you have to the') }} <b> {{ __('store owner.') }} </b> </p>
                        ...
                        <div class="d-flex justify-content-center backbtn">
                            <a href="{{ route('landing_page', $slug) }}" class="btn-secondary">
