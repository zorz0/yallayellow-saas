...
<div class="row">
    ...
    <div class="form-group col-md-6 format">
        ...
        {!! Form::select('applied_product[]', $product, null, [
    ...
    <div class="form-group col-md-6 format">
        ...
        {!! Form::select('exclude_product[]', $product, null, [
            'class' => 'form-control select2',
            'id' => 'exclude_product',
            'multiple',
            'data-role' => 'tagsinput',
    ...
    <div class="form-group col-md-6 format">
        ...
        {!! Form::select('applied_categories[]', $category, null, [
            'class' => 'form-control select2',
    ...
    <div class="form-group col-md-6 format">
        ...
        {!! Form::select('exclude_categories[]', $category, null, [
            'class' => 'form-control select2',
